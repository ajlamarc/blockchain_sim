...
def main():
    ...
    for y in range(1, Y):
        ...
        print("Traditional premium total for year " + str(y) + ": $" +
              str(totalTraditionalPremium))

        print("Smart contract premium total for year " +
              str(y) + ": $" + str(totalSmartContractPremium))

        print("Expenses per child in year " +
              str(y) + ": $" + str(round(bs.pediatricTotalCost / bs.Cn)))

        print("Expenses per young adult in year " + str(y) +
              ": $" + str(round(bs.youngTotalCost / bs.Yn)))

        print("Expenses per older adult in year " + str(y) +
              ": $" + str(round(bs.oldTotalCost / bs.On)))

        totalCost = bs.pediatricTotalCost + bs.youngTotalCost + bs.oldTotalCost
        print("Total medical expenses for cohousing community in year " +
              str(y) + ": $" + str(totalCost))
